...
class CartLineItems extends HTMLElement {
  ...
  handleCartAdd(e) {
    ...
    window.eight.sectionsEngine.sectionRenderingEngine.fetchSection('?', ['flotilla-cart-main'], [els], ['[data-armada-selector="cart-main-section"]']);
  }
  ...
  handleEmptyCart(item_count) {
    ...
    window.eight.sectionsEngine.sectionRenderingEngine.fetchSection('?', ['flotilla-cart-main'], [this.cartMainSectionParent], [this.cartMainSectionInner]);
  }
