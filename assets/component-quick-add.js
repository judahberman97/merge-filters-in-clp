...
class QuickAdd extends HTMLElement {
  ...
  render() {
    ...
    this._classList = this.querySelector('[data-name="product-submit"]').classList;
    this.buttonWrap = this.querySelector('[data-name="product-submit-wrapper"]');
  ...
  buttonHtml(type = 'add') {
    ...
    const labels = {
      'add': window.variantStrings.addToCart,
      'choose': window.variantStrings.choose,
      'sold-out': window.variantStrings.soldOut,
      'added': window.variantStrings.added,
      'unavailable': window.variantStrings.unavailable
    };
    ...
    const ariaLabels = {
      'add': window.variantStrings.addToCart,
      'choose': window.variantStrings.chooseVariant,
      'sold-out': `'${this.currentVariant.title}' ${window.variantStrings.isSoldOut}`,
      'added': `${window.variantStrings.added} '${this.currentVariant.title}'`,
      'unavailable': window.variantStrings.unavailable
    };
