...
class CartCrossSells extends HTMLElement {
  ...
  init(listeners = false) {
    ...
    if (crossSellSection) {
      this.matchingColorSchemes ? crossSellSection.classList.add('xl:border-l', 'xl:border-l-border-opacity-10', 'border-t', 'border-t-border-opacity-10', 'xl:border-t-0') : '';
    }
  ...
  pinSummaryToBottom() {
    ...
    if (
      ...
      window.eight.cartEngine?.globalCart?.cart.item_count > 0
    ) {
